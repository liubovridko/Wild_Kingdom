// Підключення з node_modules (або підключаємо через task libsCss, libsJs)
// Якщо потрібно змінювати стилі - підключити з файлу range.scss, розкоментувавши range у style.scss
// import * as noUiSlider from 'nouislider'

// Підключення стилів із node_modules
 ...
 const rangeItems = document.querySelectorAll('[data-range]')
   if (rangeItems.length) {
     rangeItems.forEach((rangeItem) => {
       ...
       //зв'язування з інпутами (у документації)
