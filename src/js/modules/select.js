const getTemplate = (data = [], placeholder, selectedId) => {
 ...
 class Select {
   ...
   // зробив метод роботи з шаблонами приватним
   #render() {
   ...
   // приватний метод роботи з налаштуваннями
   #setup() {
   ...
   // заповнює інпут даними при кліку
   select(id) {
     this.selectedId = id
   ...
   // якщо елемент відкритий, закриває та навпаки
   toggle() {
